...
CC_SRCS += \
../Utilities/tensorflow/lite/schema/schema_utils.cc 

CC_DEPS += \
./Utilities/tensorflow/lite/schema/schema_utils.d 

OBJS += \
./Utilities/tensorflow/lite/schema/schema_utils.o 


# Each subdirectory must supply rules for building sources it contributes
Utilities/tensorflow/lite/schema/%.o Utilities/tensorflow/lite/schema/%.su: ../Utilities/tensorflow/lite/schema/%.cc Utilities/tensorflow/lite/schema/subdir.mk
...
clean: clean-Utilities-2f-tensorflow-2f-lite-2f-schema

clean-Utilities-2f-tensorflow-2f-lite-2f-schema:
	-$(RM) ./Utilities/tensorflow/lite/schema/schema_utils.d ./Utilities/tensorflow/lite/schema/schema_utils.o ./Utilities/tensorflow/lite/schema/schema_utils.su

.PHONY: clean-Utilities-2f-tensorflow-2f-lite-2f-schema
